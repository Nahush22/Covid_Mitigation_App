...
public class MaterialVolunteerMapActivity extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = "Material Volunteer Map:";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.material_volunteer_map);

        reg = findViewById(R.id.volMaterialMapReg);
...
//                    Toast.makeText(getApplication(), String.valueOf(myLat) + "," + String.valueOf(myLong), Toast.LENGTH_SHORT).show();
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.volunteerMaterialMap);
        ...
        db.collection("VolunteerID").document(userID).collection("Tasks").document("NAN")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(MaterialVolunteerMapActivity.this, "Volunteer Registered!", Toast.LENGTH_SHORT).show();

                        finish();
                        startActivity(new Intent(MaterialVolunteerMapActivity.this,MaterialVolunteerTaskActivity.class));
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
...
//        map.setOnInfoWindowClickListener((GoogleMap.OnInfoWindowClickListener) MainActivity.this);
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragStart(Marker marker) {
                ...
                // Here your code
                Toast.makeText(MaterialVolunteerMapActivity.this, "Starting to drag marker",
