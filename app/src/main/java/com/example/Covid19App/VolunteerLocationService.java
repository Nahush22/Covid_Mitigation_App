...
//    private final long MIN_DIST = 20;
    ...
    public VolunteerLocationService() {
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent notificationIntent = new Intent(this, VolunteerTaskActivity.class);
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentText(getResources().getString(R.string.VolunteerNotifString))
