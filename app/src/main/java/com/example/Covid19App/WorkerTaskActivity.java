...
public class WorkerTaskActivity extends AppCompatActivity {
    ...
    private static final String TAG = "WorkerTaskActivity:";
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = findViewById(R.id.workerTaskTitle);

        adminId = findViewById(R.id.workerAdminTxt);
        brief = findViewById(R.id.workerBriefTxt);
        desc = findViewById(R.id.workerTaskDescTxt);
        address = findViewById(R.id.workerAddressTxt);
        noTask = findViewById(R.id.workerTaskStatusTxt);

        acceptBtn = findViewById(R.id.workerAcceptBtn);
        denyBtn = findViewById(R.id.workerDenyBtn);
        completedBtn = findViewById(R.id.workerTaskComplBtn);
        locBtn = findViewById(R.id.workerTaskLocBtn);

        statusTxt = findViewById(R.id.workerPassStatus);
        signUpTxt = findViewById(R.id.workerTaskSignUpBtn);

        loadUserId();

        getStatus();

//        getTaskData();//See inside gets status function where if accepted this is loaded
        ...
        signUpTxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                startActivity(new Intent(getApplicationContext(), WorkerSignUp.class).putExtra("activity", "TaskActivity"));
            }
        });
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if(document.getData()!=null)
                        {
                            ...
                            {
                                statusTxt.setText("Pass request has been rejected");
                                statusTxt.setVisibility(View.VISIBLE);
                                signUpTxt.setVisibility(View.VISIBLE);
                            }
                            else
                            {
                                statusTxt.setText("Pass request is pending approval...");
                                statusTxt.setVisibility(View.VISIBLE);
                            }
                        }
...
//        mapIntent.setPackage("com.google.android.apps.maps");
    ...
    private void completeTask() {
        ...
        Toast.makeText(this, "Task Assigned!Wait for admin confirmation!", Toast.LENGTH_SHORT).show();



        db.collection("Worker").document(userId).collection("Tasks").document(docId)
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(document.getData() != null)
                                {
                                    ...
                                    if(volunteerID.equals(userId))
                                    {
                                        ...
                                        Toast.makeText(WorkerTaskActivity.this, "Task completed & SMS sent to admin", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        } else {
        ...
        builder.setMessage("Task accepted!User location will now be tracked to ensure social distancing.This can be disabled by rejecting or completing the task.")
                ...
                .setNeutralButton("Okay", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent serviceIntent = new Intent(WorkerTaskActivity.this, LocationMonitorService.class);
                        serviceIntent.putExtra("type", "vol");

                        ContextCompat.startForegroundService(WorkerTaskActivity.this, serviceIntent);
...
//                        {
        ...
        db.collection("Worker").document(userId).collection("Tasks")
                .whereEqualTo("Assigned", 1)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    @Override
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d(TAG, "Error getting documents: ", task.getException());
                            Toast.makeText(WorkerTaskActivity.this, "Error retrieving from database", Toast.LENGTH_SHORT).show();
                            progressDialogdb.dismiss();
                        }
                    }
                });
