...
public class MaterialVolunteerTaskActivity extends AppCompatActivity {

    private static final String TAG = "MaterialVolunteerTaskActivity:";
    ...
    Button acceptBtn, denyBtn, completedBtn;
    ImageView locBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.material_volunteer_task);

        taskCard = findViewById(R.id.materialTaskCard);

        adminId = findViewById(R.id.materialVolAdminId);
        brief = findViewById(R.id.materialVolBrief);
        desc = findViewById(R.id.materialVolDesc);
        address = findViewById(R.id.materialVolAddressTxt);

        noTask = findViewById(R.id.materialVolNoTasksTxt);

        acceptBtn = findViewById(R.id.materialVolAcceptBtn);
        denyBtn = findViewById(R.id.materialVolRejectBtn);
        completedBtn = findViewById(R.id.materialVolCompltBtn);

        locBtn = findViewById(R.id.materialVolLocImg);
                            ...
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                if(document.getData() != null)
                                {
                                    ...
                                    if(volunteerID.equals(userId))
                                    {
                                        ...
                                        Toast.makeText(MaterialVolunteerTaskActivity.this, "Task completed & SMS sent to admin", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        } else {
        ...
        builder.setMessage("Task accepted!User location will now be tracked to ensure social distancing.This can be disabled by rejecting or completing the task.")
                ...
                .setNeutralButton("Okay", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent serviceIntent = new Intent(MaterialVolunteerTaskActivity.this, LocationMonitorService.class);
                        serviceIntent.putExtra("type", "vol");

                        ContextCompat.startForegroundService(MaterialVolunteerTaskActivity.this, serviceIntent);
...
//                                    Toast.makeText(MaterialVolunteerTaskActivity.this, document.get("Address").toString(), Toast.LENGTH_SHORT).show();
                                    ...
                                    adminId.setText(document.get("AdminID").toString());
                                    brief.setText(document.get("Brief").toString());
                            ...
                            Log.d(TAG, "Error getting documents: ", task.getException());
                            Toast.makeText(MaterialVolunteerTaskActivity.this, "Error retrieving from database", Toast.LENGTH_SHORT).show();
                            progressDialogdb.dismiss();
                        }
                    }
                });
