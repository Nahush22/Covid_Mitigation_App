...
public class MigrantLocationSignUp extends AppCompatActivity implements OnMapReadyCallback {

    private static final String TAG = "MigrantLocationSignUp";
    Button reg;
    ...
    String name, no, home, current, gender;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_migrant_location_sign_up);

        reg = findViewById(R.id.migrantLocUpdateBtn);
...
//                    Toast.makeText(getApplication(), String.valueOf(myLat) + "," + String.valueOf(myLong), Toast.LENGTH_SHORT).show();
        ...
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.migrantCurrentLocationMap);
...
//        }
    ...
    private void verifyDetails() {
        if(name == null || no == null || home == null || current == null || gender == null)
        {
    ...
    private void updateSellerDb() {
        ...
        migrant.put("UserID", userID);
        migrant.put("Name", name);
        migrant.put("Number", no);
        migrant.put("Home", home);
        migrant.put("Location", current);
        migrant.put("Gender", gender);
        migrant.put("Latitude", String.valueOf(myLat));
        migrant.put("Longitude", String.valueOf(myLong));
        migrant.put("Assigned", 0);
        ...
        db.collection("Migrants")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        ...
                        Toast.makeText(MigrantLocationSignUp.this, "Migrant has been registered!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
...
//        map.setOnInfoWindowClickListener((GoogleMap.OnInfoWindowClickListener) MainActivity.this);
        ...
        map.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
            ...
            public void onMarkerDragStart(Marker marker) {
                ...
                // Here your code
                Toast.makeText(MigrantLocationSignUp.this, "Starting to drag marker",
